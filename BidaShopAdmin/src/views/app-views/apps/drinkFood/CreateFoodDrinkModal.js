...
import { Modal, Form, Input, InputNumber, Select, Switch, Spin, message } from "antd";
import { createDrinkFood } from "services/drinkFoodService";
import { getAllCategories } from "services/categoryService";
import { getAllFacilities } from "services/facilityService"; // Thêm hàm fetch chi nhánh
import { getFacilityByUser } from "services/facilityUserService";

const { Option } = Select;

const CreateFoodDrinkModal = ({ visible, onCancel, refreshDrinkFoods }) => {
  ...
  const handleFinish = async (values) => {
    ...
    try {
      ...
      onCancel();
      message.success("Thêm món ăn/đồ uống thành công!");
    } catch (error) {
...
export default CreateFoodDrinkModal;
