...
export const getAllUsers = async (page = 1, limit = 100, keyword = "", role = "") => {
  try {
...
export const getAllStaff = async (page = 1, limit = 100, keyword = "", role = "") => {
  try {
    const response = await axios.get(`${API_URL}/users/all-staff`, {
      params: {
        keyword,
        role,
        page,
